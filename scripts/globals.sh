...
export RESULTS_PTRBENCH_SVF_ANDER="$RESULTS_PTRBENCH/SVF/ander"
export RESULTS_PTRBENCH_SVF_FSPTA="$RESULTS_PTRBENCH/SVF/fspta"
export RESULTS_PTRBENCH_SVF_VFSPTA="$RESULTS_PTRBENCH/SVF/vfspta"
export RESULTS_PTRBENCH_SVF_CXT="$RESULTS_PTRBENCH/SVF/cxt"
...
export RESULTS_TSUITE_SVF_ANDER="$RESULTS_TSUITE/SVF/ander"
export RESULTS_TSUITE_SVF_FSPTA="$RESULTS_TSUITE/SVF/fspta"
export RESULTS_TSUITE_SVF_VFSPTA="$RESULTS_TSUITE/SVF/vfspta"
