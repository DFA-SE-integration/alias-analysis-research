...
export RES_DIR="$RESULTS_PTRBENCH_SVF_ANDER"
run_one_file() {
...
export RES_DIR="$RESULTS_PTRBENCH_SVF_FSPTA"
run_one_file() {
  local bc_file="$1" log_file="$2" test_dir="$3"
...
export RES_DIR="$RESULTS_PTRBENCH_SVF_VFSPTA"
run_one_file() {
  local bc_file="$1" log_file="$2" test_dir="$3"
...
export RES_DIR="$RESULTS_PTRBENCH_SVF_CXT"
run_one_file() {
  local bc_file="$1" log_file="$2" test_dir="$3"
